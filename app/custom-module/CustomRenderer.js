...
export default class CustomRenderer extends BaseRenderer {
  constructor(eventBus, bpmnRenderer, directEditing) {
  ...
  drawShape(parentNode, element) {
    ...
    if (!isNil(suitabilityScore)) {
      ...
      const rect = drawRect(parentNode, 50, 20, Lane_BORDER_RADIUS, color);
...
CustomRenderer.$inject = ['eventBus', 'bpmnRenderer', 'directEditing'];
